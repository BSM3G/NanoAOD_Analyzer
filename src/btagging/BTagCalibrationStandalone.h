...
public:
  ...
  BTagCalibration(const BTagCalibration& other);
  BTagCalibration& operator=(const BTagCalibration& rhs);
...
public:
  ...
  BTagCalibrationReader(const BTagCalibrationReader& other);
  BTagCalibrationReader& operator=(const BTagCalibrationReader& rhs);
