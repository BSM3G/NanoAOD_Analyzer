...
BTagCalibration::BTagCalibration(const BTagCalibration& other) {
  tagger_ = other.tagger_;
  data_ = other.data_;
}

BTagCalibration& BTagCalibration::operator=(const BTagCalibration& rhs) {
...
BTagCalibrationReader::BTagCalibrationReader(const BTagCalibrationReader& other) {
  pimpl = other.pimpl;
}

BTagCalibrationReader& BTagCalibrationReader::operator=(const BTagCalibrationReader& rhs) {
  if(this == &rhs) return *this;
