...
// GenMuons::GenMuons(TTree* _BOOM, std::string filename, std::vector<std::string> syst_names) : Particle(_BOOM, "GenPart", filename, syst_names) {
...
// GenElectrons::GenElectrons(TTree* _BOOM, std::string filename, std::vector<std::string> syst_names) : Particle(_BOOM, "GenPart", filename, syst_names) {
