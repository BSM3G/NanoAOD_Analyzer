...
enum class CUTS {
  ...
  eGJet,        eGBJet,       eGHadTau,     eGMatchedHadTau,          eGPhoton,
  eRVertex,     eRMuon1,      eRMuon2,      eRMuon3,      eRElec1,      eRElec2,    eRTau1,   eRTau2,
  eRPhot1,      eRPhot2,
  eRJet1,       eRJet2,       eRJet3, eQCDRejection, eRCenJet,     eR1stJet,     eR2ndJet,   
  eRBJet,   eRWjet,
  eDiElec,      eDiMuon,      eDiTau,       eDiJet,       eDiPhoton,
...
static std::unordered_map<CUTS, std::string, EnumHash> enumNames {
  ...
  {CUTS::eGTau, "eGTau"}, {CUTS::eGTop, "eGTop"}, {CUTS::eGElec, "eGElec"}, {CUTS::eGMuon, "eGMuon"}, {CUTS::eGZ, "eGZ"},
	{CUTS::eGW, "eGW"}, {CUTS::eGHiggs, "eGHiggs"}, {CUTS::eGJet, "eGJet"},  {CUTS::eGBJet, "eGBJet"}, {CUTS::eGPhoton, "eGPhoton"},
  {CUTS::eRVertex, "eRVertex"},
  {CUTS::eRMuon1, "eRMuon1"}, {CUTS::eRMuon2, "eRMuon2"}, {CUTS::eRMuon3, "eRMuon3"},
  {CUTS::eRElec1, "eRElec1"}, {CUTS::eRElec2, "eRElec2"},
  {CUTS::eRPhot1, "eRPhot1"}, {CUTS::eRPhot2, "eRPhot2"},
  {CUTS::eRTau1, "eRTau1"},   {CUTS::eRTau2, "eRTau2"}, {CUTS::eRJet1, "eRJet1"}, {CUTS::eRJet2, "eRJet2"}, {CUTS::eRJet3, "eRJet3"},
  {CUTS::eRCenJet, "eRCenJet"}, {CUTS::eR1stJet, "eR1stJet"}, {CUTS::eR2ndJet, "eR2ndJet"}, {CUTS::eRBJet, "eRBJet"},
  {CUTS::eRWjet, "eRWjet"}, {CUTS::eQCDRejection, "eQCDRejection"},
  {CUTS::eDiElec, "eDiElec"}, {CUTS::eDiMuon, "eDiMuon"}, {CUTS::eDiTau, "eDiTau"}, {CUTS::eDiJet, "eDiJet"}, {CUTS::eDiPhoton, "eDiPhoton"}, 
  {CUTS::eMuon1Tau1, "eMuon1Tau1"}, {CUTS::eMuon1Tau2, "eMuon1Tau2"}, {CUTS::eMuon2Tau1, "eMuon2Tau1"},
