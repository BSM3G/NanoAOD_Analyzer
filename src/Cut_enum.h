...
enum class CUTS {
  ...
  eRJet1,       eRJet2,       eRCenJet,     eR1stJet,     eR2ndJet,   eRBJet,   eRWjet, eRFailPUJetID,
...
static std::unordered_map<CUTS, std::string, EnumHash> enumNames {
  ...
  {CUTS::eRWjet, "eRWjet"}, {CUTS::eRFailPUJetID, "eRFailPUJetID"}, {CUTS::eDiElec, "eDiElec"}, {CUTS::eDiMuon, "eDiMuon"}, {CUTS::eDiTau, "eDiTau"},
