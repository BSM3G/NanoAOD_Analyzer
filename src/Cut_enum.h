...
enum class CUTS {
  eGen,
  eGTau,        eGTop,        eGElec,       eGMuon,       eGZ,        eGW,      eGHiggs, eGJet, eGBJet, eGHadTau,
...
static std::unordered_map<CUTS, std::string, EnumHash> enumNames {
  ...
  {CUTS::eSusyCom, "eSusyCom"}, {CUTS::eMET, "eMET"}, {CUTS::eGNuTau, "eGNuTau"}, {CUTS::eGHadTau, "eGHadTau"}, {CUTS::eRTrig1, "eRTrig1"}, {CUTS::eRTrig2, "eRTrig2"}
  };
